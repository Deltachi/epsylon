<template>
    <div v-if="ready">
        <task1 v-if="parseInt(task.type) === 1"
               :data-task="task"
               ...
               ref="taskRef"
        ></task1>
        <task2 v-if="parseInt(task.type) === 2"
               :data-task="task"
               :trigger-answer-loaded="pushToChild"
               @save="triggerSaveHandle"
               @reset="triggerResetHandle"
               ref="taskRef"
        ></task2>
        <task3 v-if="parseInt(task.type) === 3"
               :data-task="task"
               :trigger-answer-loaded="pushToChild"
               @save="triggerSaveHandle"
               @reset="triggerResetHandle"
               ref="taskRef"
        ></task3>
        <task4 v-if="parseInt(task.type) === 4"
               :data-task="task"
               :trigger-answer-loaded="pushToChild"
               @save="triggerSaveHandle"
               @reset="triggerResetHandle"
               ref="taskRef"
        ></task4>
        <task5 v-if="parseInt(task.type) === 5"
               :data-task="task"
               :trigger-answer-loaded="pushToChild"
               @save="triggerSaveHandle"
               @reset="triggerResetHandle"
               ref="taskRef"
        ></task5>
        <task6 v-if="parseInt(task.type) === 6"
               :data-task="task"
               :trigger-answer-loaded="pushToChild"
               @save="triggerSaveHandle"
               @reset="triggerResetHandle"
